        ...
        <div className="below-fullscreen">
          ...
          <section className="inverted">
            ...
            <div className="row">
              ...
              <div className="item">
                <a href="https://drive.google.com/open?id=0B2J6pHGTd-CtX3RCVlBLdzJMME0" target="_blank">
                  <img src="/portfolio_2.png" width="400" height="250" alt="My Resume" /></a>
                <footer>
                  <span>
                    <a href="https://drive.google.com/open?id=0B2J6pHGTd-CtX3RCVlBLdzJMME0" target="_blank">My Resume</a>
                  </span>
                </footer>
              </div>
            </div>
